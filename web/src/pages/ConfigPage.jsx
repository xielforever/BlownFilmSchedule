...
const policySettingLabels = {
  ...
  arc_pruning_same_material_family_top_k: '材料族 top-k 弧',
  arc_pruning_same_cleanroom_top_k: '洁净等级 top-k 弧',
  arc_pruning_due_window_mins: '交期窗口(分钟)',
  arc_pruning_due_window_top_k: '交期窗口 top-k 弧',
