...
export const policyFieldRuleClasses = {
  ...
  solver_phase1_tardiness_weight: 'soft',
  solver_phase1_late_order_penalty: 'soft',
  solver_phase2_tardiness_weight: 'soft',
  solver_max_late_order_count: 'soft',
  solver_max_weighted_tardiness: 'soft',
  ...
  candidate_post_solve_late_defer_count: 'soft',
