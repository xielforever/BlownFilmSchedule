...
export const getScheduleSettings = () => api.get('/schedule/settings');
export const updateScheduleSettings = (payload) => api.patch('/schedule/settings', payload);
export const getConfigAudit = (params) => api.get('/schedule/config-audit', { params });
export const createPreplan = (payload) => api.post('/schedule/preplans', payload);
export const getPreplans = () => api.get('/schedule/preplans');
export const getPreplan = (runId) => api.get(`/schedule/preplans/${runId}`);
export const adjustPreplanTask = (runId, payload) => api.post(`/schedule/preplans/${runId}/adjustments`, payload);
...
export const updateManufacturingQueueItem = (id, payload) => api.patch(`/schedule/manufacturing-queue/${id}`, payload);
...
export const createOrderScreeningAction = (id, payload) => api.post(`/orders/${id}/screening-action`, payload);
export const getOrderScreeningActions = (id) => api.get(`/orders/${id}/screening-actions`);
...
export const resetOrdersToPending = () => api.post('/orders/reset-to-pending');
export const getMachines = () => api.get('/machines');
export const updateMachine = (id, payload) => api.patch(`/machines/${id}`, payload);
export const applyScheduleEndState = (runId) =>
  api.post('/machines/apply-schedule-end-state', null, { params: runId ? { run_id: runId } : {} });
...
export const getMaintenanceDuplicates = () => api.get('/rules/maintenance/duplicates');
export const dedupeMaintenanceWindows = () => api.post('/rules/maintenance/dedupe');
